...
1. With Chrome, navigate to the **IoT Service cockpit** address within the **IoT - AE** bookmark folder provided by your instructor and login with the related credentials. ![](images/000.png)
